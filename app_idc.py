...
import tools.viz_slider as viz_mod
...
viz_mod.configure_viz_slider_tool()
...
def build_graph(checkpointer=None):
    policy = SystemMessage(content=(
        ...
        - Only when asked about VoxelInsight or VoxelInsight IDC (you), answer yourself otherwise always use tools. YOU ARE NOT ALLOWED TO ANSWER DIRECTLY.
        - When asked general questions about the IDC (not about voxelinsight), use the idc_web_qa tool to search IDC documentation and return a grounded answer. For very generic questions you can answer directly if you are confident, but when in doubt use the web QA tool to get a grounded answer.
        ...
        Tools
        - The idc_query tool can plot graphs too and can both query data and plot a graph in a single call.
