...
async def on_message(message: cl.Message):
    ...
    3) Segmentation: Supports two algorithmic implementations: TotalSegmentator and NNUNet_v2 \
    TotalSegmentator, which supports organ and lesion segmentation from CT/MRI NIfTI files. \
